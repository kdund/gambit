...
add_custom_target(boost_python-distclean 
                                #COMMAND ${CMAKE_COMMAND} -E remove_directory "contrib/boost_python"
                                #COMMAND ${CMAKE_COMMAND} -E remove_directory "${PROJECT_BINARY_DIR}/boost_python-prefix"
                                COMMAND ${CMAKE_COMMAND} -E remove_directory "contrib/boost_python/build"
                                COMMAND ${CMAKE_COMMAND} -E remove_directory "contrib/boost_python/lib"
                                COMMAND ${CMAKE_COMMAND} -E remove_directory "${PROJECT_BINARY_DIR}/ScannerBit/python/boost_python-prefix"
                                COMMAND ${CMAKE_COMMAND} -E make_directory "contrib/boost_python/build"
                                COMMAND ${CMAKE_COMMAND} -E touch "contrib/boost_python/build/.gitignore" 
