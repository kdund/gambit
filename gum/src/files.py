...
def find_and_replace(filename, split_string, old, new):
    """
    Finds a string in a file, and replaces it with a new one
    
    This is to use for generated GUM files, not alterring GAMBIT files,
    as this will not be reverted by a mug file
    
    NOTE: Currently only using to patch pythia files generated by MadGraph for pythia 8.3
    """
    ...
    for line in reading_file:
        stripped_line = line.strip(split_string)
