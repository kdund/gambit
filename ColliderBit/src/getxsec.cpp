...
namespace Gambit
{
  ...
  namespace ColliderBit
  {
    ...
    void PerformInitialCrossSection_Pythia(initialxsec_container& result)
    {
      ...
      Py8Collider_defaultversion pythia; // TODO: Model specific templating
      ...
      for (std::string collider : collider_names)
      {
        ...
        #pragma omp parallel private(pythia)
        {
          ...
          Pythia_8_212::Pythia8::Event dummy_pythia_event; // TODO: templated with Pythia event type
          try
          {
        ...
        std::cout << "Cross-section result: " << TotalXsecContainer[collider].xsec() << std::endl;
