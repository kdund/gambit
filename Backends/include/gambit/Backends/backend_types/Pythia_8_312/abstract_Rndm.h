#ifndef __abstract_Rndm_Pythia_8_312_h__
#define __abstract_Rndm_Pythia_8_312_h__
    ...
    namespace Pythia8
    {
        class Abstract_Rndm : public virtual AbstractBase
        {
            public:
                ...
                virtual double gamma(double, double) =0;
                ...
                virtual const int& DEFAULTSEED_ref__BOSS() =0;
...
#endif /* __abstract_Rndm_Pythia_8_312_h__ */
